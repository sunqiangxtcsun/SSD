...
def VGGNetBody_small(net, from_layer, need_fc=True, fully_conv=False, reduced=False,
    ...
    net.conv5_3 = L.Convolution(net.relu5_1, num_output=256, pad=pad, kernel_size=kernel_size, dilation=dilation, **kwargs)
